...
namespace Klasskamrater
{
    public class MemberHandler
    {
        public static List<ClassMates> PopulateList()
        {
            ...
            //populate.Add(new KlassKamrat { Name = "ÄnnuÄnnuAnnan Person", Age = 33, Length = 187, City = "Umeå", Hobby = "odla gurka", FavouriteFood = "Cowboysoppa", FavouriteDrink = "Gin och Tonic", FavouriteBand = "Infected Mushroom", Children = 0, ProgrammingMotivation = "Personlig utveckling och kreativitet" });
            return populate;
        }
    }
}
